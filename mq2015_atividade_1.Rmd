---
title: "Captura de dados da internet, sistematização o e análise de ”Big data” - Atividade 1"
...
Vamos começar visitando o site portal da transparencia: http://www.portaldatransparencia.gov.br/ No site, vamos explorar os dados sobre servidores públicos federais. Clique na aba "Servidores" e escolha "por nome ou CPF". São 70.761 páginas contendo 15 servidores cada.

```{r}
70761 * 15 
```

São 1.061.415 servidores ao todo!!!! Temos a informação de alguns dígitos do CPF, nome, orgão de lotação, orgão de exercício e jornada de trabalho. Todas essas informacoes são públicas!
